...
// relationship only
rows.push(mk({ accountName: 'Gamma Corp', alias: 'Gamma Global', accountId: 'ACC-020', region: 'NA', mid: 'mid_2003', created: '2023-11-02', type: 'Enterprise', owner: 'Carol Lee', accountManager: 'Ada Lovelace', group: 'gamma.net', classification: 'Primary', reason: 'Same domain', complexity: 'Low' }));
...
rows.push(mk({ accountName: 'Zeta One', alias: 'Zeta Prime', accountId: 'ACC-050', region: 'APAC', mid: 'mid_5005', created: '2024-02-10', type: 'SMB', owner: 'Fay Ng', accountManager: 'Alan Turing', group: 'zeta.com', classification: 'Unclassified', reason: 'Needs manual review', complexity: 'Low', relationships: 'sibling: Zeta Two' }));
